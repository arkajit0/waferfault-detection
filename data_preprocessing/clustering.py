...
from Training_File_DB_operations.DataTypeValidation_db_insertion import Model_saving_loading
...
class KMeansClustering:
    ...
    def elbow_plot(self, data):
        """
                ...
                """
        self.logger_object.db_log(self.file_object, "Entered the elbow_plot method of the KMeansClustering class")
    ...
    def create_clusters(self,data,number_of_clusters):
        """
                        ...
                        """
        self.logger_object.db_log(self.file_object, "Entered the create_clusters method of the KMeansClustering class")
        self.data=data
        try:
            ...
            # self.file_op.create_model_directory() #creating a directory to keep models
            # self.save_model = self.file_op.save_model(self.kmeans, 'KMeans')
            self.model_ops.save_model_db(collection_name="KMeans", model=self.kmeans, model_name="KMeans",
                                         model_score=None)       # saving the KMeans model to directory
