...
class Preprocessor:
    ...
    def remove_columns(self,data,columns):
        ...
        """
        self.logger_object.db_log(self.file_object, "Entered the remove_columns method of the Preprocessor class")
        self.data=data
    ...
    def separate_label_feature(self, data, label_column_name):
        ...
        # except Exception as e:
        #     self.logger_object.training_logs(self.file_object,
        #                                      message={"message": "Exception occured in separate_label_feature method of the Preprocessor class. Exception message:  " + str(e)})
        #     self.logger_object.training_logs(self.file_object, message={"message": "Label Separation Unsuccessful. Exited the separate_label_feature method of the Preprocessor class"})
        #     raise Exception()

    def is_null_present(self, data, database_name, collection_name):
        """
                        ...
                        """
        self.logger_object.db_log(self.file_object, "Entered the is_null_present method of the Preprocessor class")
        ...
        if(self.null_present): # write the logs to see which columns have null values
            ...
            # self.fileoperations.create_container(container_name="preprocessing-data")
            # self.fileoperations.uploadfiles(container_name="preprocessing-data", filename="null_values.csv",
            #                                 data=dataframe_with_null.to_csv(index=False))

            self.db_ops.insert_null_values(database_name=database_name, collection_name=collection_name,
                                           csv_data=dataframe_with_null)
    ...
    def impute_missing_values(self, data):
        """
                                        ...
                                        Revisions: None
                     """
        self.logger_object.db_log(self.file_object, "Entered the impute_missing_values method of the Preprocessor class")
        self.data= data
        try:
    ...
    def get_columns_with_zero_std_deviation(self,data):
        ...
        try:
            ...
            self.logger_object.db_log(self.file_object,
                                      "Exception occured in get_columns_with_zero_std_deviation method of the Preprocessor class. Exception message:  " + str(e))
            self.logger_object.db_log(self.file_object,
