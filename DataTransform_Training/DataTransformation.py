...
class dataTransform:
     ...
     def replaceMissingWithNull(self):
          ...
          try:
               ...
               # onlyfiles = self.fileoperation.getallFiles(self.goodDataPath)
               onlyfiles = self.db_ops.get_files(database_name="Data_Collection", collection_name="Good_Data")
               for file in onlyfiles:
                    # csv = pandas.read_csv(self.goodDataPath+"/" + file)
                    # csv = self.fileoperation.downloadfiles(container_name=self.goodDataPath, filename=file)
                    ...
                    # self.fileoperation.uploadfiles(container_name=self.goodDataPath, filename=file,
