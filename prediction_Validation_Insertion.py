...
class pred_validation:
    ...
    def prediction_validation(self):
        ...
        try:
            ...
            self.log_writer.db_log(self.file_object, "Creating Prdiction_Database and collection on the basis of given schema!!!")
            ...
            self.dBOperation.insertintocollection_gooddata(Database_name="Prediction_Files", collection_="Prediction_csv",
                                                           source_database="Data_Collection_Prediction",
                                                           source_collection="Good_Data")
